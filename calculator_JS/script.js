/* let analytesData = null; // Globale Variable
...
document.addEventListener('DOMContentLoaded', function() {
    fetch('analytes.json')
        ...
        .then(data => {
            analytesData = data; // Speichern der Daten in der globalen Variable
            createTabsAndCheckboxes(analytesData); // Aufruf der Funktion, nachdem die Daten geladen wurden
        })
        .catch(error => {
            console.error('Fehler beim Laden von analytes.json:', error);
        });
});
